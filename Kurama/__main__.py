...
from Kurama import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
                          OWNER_ID, PORT, SUPPORT_CHAT, TOKEN, URL, WEBHOOK,
                          SUPPORT_CHAT, dispatcher, StartTime, telethn, updater)
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from Kurama.modules import ALL_MODULES
from Kurama.modules.helper_funcs.chat_status import is_user_admin
from Kurama.modules.helper_funcs.misc import paginate_modules
...
PM_START_TEXT = """
Hi {}, my name is {}! 
I am one of the tailed beasts which existed long ago.
Onced I attacked Konoha village because of being controlled by an evil man named Madara Uchiha.
...
I'm a Beast helping admins manage their groups with my powers! Have a look at the following for an idea of some of \
...
KURAMA_IMG = "https://telegra.ph/file/46e6d9dfcb3eb9eae95d9.jpg"
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Kurama.modules." +
                                              module_name)
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text="☑️ Add Kurama to your group",
                     ...
                     [
                         InlineKeyboardButton(
                             text="🗄 Source code",
                             url="https://github.com/Amazers392/KuramaRobot")
                     ]]))
    else:
