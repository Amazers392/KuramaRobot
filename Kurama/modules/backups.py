...
import Kurama.modules.sql.notes_sql as sql
from Kurama import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from Kurama.__main__ import DATA_IMPORT
from Kurama.modules.helper_funcs.chat_status import user_admin
from Kurama.modules.helper_funcs.alternate import typing_action

# from Kurama.modules.rules import get_rules
import Kurama.modules.sql.rules_sql as rulessql

# from Kurama.modules.sql import warns_sql as warnssql
import Kurama.modules.sql.blacklist_sql as blacklistsql
from Kurama.modules.sql import disable_sql as disabledsql

# from Kurama.modules.sql import cust_filters_sql as filtersql
# import Kurama.modules.sql.welcome_sql as welcsql
import Kurama.modules.sql.locks_sql as locksql
from Kurama.modules.connection import connected
...
def export_data(update, context):
    ...
    f = open("Kurama{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Kurama{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Kurama-Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
        reply_to_message_id=msg.message_id,
        parse_mode=ParseMode.MARKDOWN,
    )
    os.remove("Kurama{}.backup".format(chat_id))  # Cleaning file
